...
import time
from pi_ros.msg import MotorFreqs
...
class MotorTest(unittest.TestCase):
	...
	def test_put_cmd_vel(self):
		...
		time.sleep(1.1)	
		self.file_check("rtmotor_raw_r0",0,"don't stop after 1[s] r0")
		self.file_check("rtmotor_raw_l0",0,"don't stop after 1[s] l0")
			
if __name__ == '__main__':
	time.sleep(3)
	rospy.init_node('travis_test_motors')
	rostest.rosrun('pi_ros','travis_test_motors', MotorTest)
