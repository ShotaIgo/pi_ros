...
class LightsensorTest(unittest.TestCase):
	...
	def chekc_values(self,lf,ls,rs,rf):
		vs = self.values
	...
	def test_get_value(self):
		rospy.set_param('lightsensors_freq',10)		#sennsor 10Hz
		time.sleep(2)					#wait getting sensor values
		with open("/dev/rtlightsensor0","w") as f:	#dimmy values write
...
if __name__ == '__main__':
	...
	rostest.rosrun('pi_ros','travis_test_lightsensors',LightsensorTest)
